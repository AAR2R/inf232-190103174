    ...
    <div class="row section-intro">
        <div class="col-twelve">
            ...
            <div class="intro-info">
                ...
                <img src="images/arsen.jpeg" alt="Profile Picture">

                <p class="lead">My name is Ardakuly Arsen, I am 19 years old. My free time is fond of programming. I love to create new designs, games. I know languages ​​like java, javascript, python, php.</p>
            </div>
        ...
        <div class="col-six tab-full">
            ...
            <ul class="info-list">
                <li>
                    ...
                    <span>Ardakuly Arsen</span>
                </li>
                <li>
                    <strong>Birth Date:</strong>
                    <span>September 2, 2002</span>
                </li>
                <li>
                    <strong>Job:</strong>
                    <span>Software engineer, engineer printer repair</span>
                </li>
                <li>
                    <strong>Email:</strong>
                    <span>arsenardakuly@gmail.com</span>
                </li>
